  ...
  const mockProducts: Product[] = useMemo(
    () => [
      ...
      },
      {
        ...
        brand: "FitTech",
        rating: 4.3,
        description: "Advanced fitness tracking with heart rate monitor, GPS, and waterproof design. Track your workouts and stay connected.",
        inStock: true,
      },
      {
        id: 3,
        ...
        brand: "PowerTech",
        rating: 4.2,
        description: "Fast wireless charging pad for smartphones with Qi technology. Compatible with all modern devices.",
        inStock: true,
      },
      {
        id: 4,
      ...
      },
      {
        ...
        brand: "PowerTech",
        rating: 4.6,
        description: "High-precision gaming mouse with RGB lighting and customizable buttons for competitive gaming.",
        inStock: true,
      },
      {
        id: 6,
        ...
        brand: "EcoWear",
        rating: 4.7,
        description: "Comfortable organic cotton t-shirt made from sustainable materials. Soft, breathable, and eco-friendly.",
        inStock: true,
      },
      {
        id: 7,
        ...
        brand: "EcoWear",
        rating: 4.5,
        description: "Classic fit denim jeans made with premium cotton blend. Durable and stylish for everyday wear.",
        inStock: true,
      },
      {
        id: 8,
        ...
        brand: "EcoWear",
        rating: 4.8,
        description: "Warm and stylish winter jacket with water-resistant coating and thermal insulation.",
        inStock: true,
      },
      {
        id: 9,
        ...
        brand: "HydroLife",
        rating: 4.6,
        description: "Insulated water bottle keeps drinks cold for 24 hours and hot for 12 hours. BPA-free and leak-proof.",
        inStock: false,
      },
      {
        id: 10,
        ...
        brand: "HydroLife",
        rating: 4.3,
        description: "Complete set of essential garden tools including trowel, pruners, and watering can.",
        inStock: true,
      },
      {
        id: 11,
        ...
        brand: "HydroLife",
        rating: 4.1,
        description: "Beautiful ceramic plant pot for indoor plants with drainage holes and matching saucer.",
        inStock: true,
      },
      {
        id: 12,
        ...
        brand: "LeatherCraft",
        rating: 4.8,
        description: "Genuine leather wallet with RFID protection and multiple card slots. Handcrafted quality.",
        inStock: true,
      },
      {
        id: 13,
      ...
      },
      {
        ...
        brand: "LeatherCraft",
        rating: 4.4,
        description: "Replaceable leather watch band compatible with most smartwatches. Premium Italian leather.",
        inStock: true,
      },
      {
        id: 15,
      ...
      },
      {
        ...
        brand: "PowerTech",
        rating: 4.0,
        description: "High-speed USB-C charging cable with fast data transfer and durable braided design.",
        inStock: true,
      },
    ],
    []
